...
graph TD
    ...
    click C "./vault-template/CLAUDE.md" "查看 vault-template 模块文档"
    click I "./.spec-workflow/CLAUDE.md" "查看 spec-workflow 模块文档"
    click J "./scripts/CLAUDE.md" "查看 scripts 模块文档"
    click H1 "./vault-template/.opencode/skill/defuddle/CLAUDE.md" "查看 defuddle 技能文档"
    click H2 "./vault-template/.opencode/skill/obsidian-cli/CLAUDE.md" "查看 obsidian-cli 技能文档"
    click H3 "./vault-template/.opencode/skill/obsidian-markdown/CLAUDE.md" "查看 obsidian-markdown 技能文档"
    click H4 "./vault-template/.opencode/skill/opencli-usage/CLAUDE.md" "查看 opencli-usage 技能文档"
    click H5 "./vault-template/.opencode/skill/smart-search/CLAUDE.md" "查看 smart-search 技能文档"
    click H6 "./vault-template/.opencode/skill/opencli-browser/CLAUDE.md" "查看 opencli-browser 技能文档"
    click H7 "./vault-template/.opencode/skill/opencli-autofix/CLAUDE.md" "查看 opencli-autofix 技能文档"
    click H8 "./vault-template/.opencode/skill/opencli-explorer/CLAUDE.md" "查看 opencli-explorer 技能文档"
    click H9 "./vault-template/.opencode/skill/opencli-oneshot/CLAUDE.md" "查看 opencli-oneshot 技能文档"
```
...
Use the `project-kb` workflow before architecture, historical decision, module-boundary, or long-running task work. Resolve the repository, read `hot.md` when it matters, and treat current code plus verification output as implementation truth.
